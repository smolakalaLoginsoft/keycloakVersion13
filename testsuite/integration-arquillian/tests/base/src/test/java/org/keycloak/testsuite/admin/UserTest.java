...
public class UserTest extends AbstractAdminTest {
    ...
    @Test
    public void WhiteSourceUsersResourceTest() {
        System.out.println("--**-- WhiteSourceUsersResourceTest UserTest.java start --**--");
        ...
        System.out.println("--**-- WhiteSourceUsersResourceTest UserTest.java end --**--");
    }
