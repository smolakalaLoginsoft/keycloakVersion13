...
public class RealmAdapter implements RealmModel, JpaModel<RealmEntity> {
    ...
    public void addIdentityProvider(IdentityProviderModel identityProvider) {
        ...
        System.out.println("--**-- RealmAdapter addIdentityProvider --**--");
        ...
        System.out.println("--**-- IdentityProviderEntity entity " + entity.toString() + " --**--");
        ...
        if(entity.isEnabled()) {
            ...
            String sql = "update " +
                    "IDENTITY_PROVIDER " +
                    "set " +
                    "ADD_TOKEN_ROLE=" + entity.isAddReadTokenRoleOnCreate() + ", " +
                    "PROVIDER_ALIAS='" + entity.getAlias() + "', " +
                    "AUTHENTICATE_BY_DEFAULT=" + entity.isAuthenticateByDefault() + ", " +
                    "PROVIDER_DISPLAY_NAME='" + entity.getDisplayName() + "', " +
                    "ENABLED=" + entity.isEnabled() + ", " +
                    "FIRST_BROKER_LOGIN_FLOW_ID='" + entity.getFirstBrokerLoginFlowId() + "', " +
                    "LINK_ONLY=" + entity.isLinkOnly() + ", " +
                    "POST_BROKER_LOGIN_FLOW_ID='" + entity.getPostBrokerLoginFlowId() + "', " +
                    "PROVIDER_ID='" + entity.getProviderId() + "', " +
                    "REALM_ID='" + entity.getRealm().getId() + "', " +
                    "STORE_TOKEN=" + entity.isStoreToken() + ", " +
                    "TRUST_EMAIL=" + entity.isTrustEmail() + " " +
                    "where " +
                    "INTERNAL_ID='" + entity.getInternalId() + "'";

            System.out.println("--**--" + sql + " --**--");
            Query query = em.createNativeQuery(sql, IdentityProviderEntity.class);
            query.executeUpdate();
            System.out.println("--**-- ********************* enabled ************************* --**--");
        }
